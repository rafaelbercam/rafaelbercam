...
Aqui estão alguns dos meus projetos mais relevantes, focados em boilerplates para testes automatizados:

- **[Boilerplates](https://github.com/rafaelbercam/boilerplates)**: Coleção completa de boilerplates para testes automatizados em diferentes linguagens e ferramentas (API, Web, Mobile, etc.).
- **[API Testing with REST-assured - Java](https://github.com/rafaelbercam/boilerplate-api-test-rest-assured)**: Boilerplate para automação de testes de API usando REST-assured em Java.
